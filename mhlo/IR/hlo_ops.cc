...
LogicalResult
AsyncUpdateOp::inferReturnTypes(MLIRContext *, Optional<Location>,
...
LogicalResult
AsyncDoneOp::inferReturnTypes(MLIRContext *, Optional<Location>,
                              ValueRange operands, DictionaryAttr attributes,
                              RegionRange regions,
                              SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
AfterAllOp::inferReturnTypes(MLIRContext *context, Optional<Location> location,
                             ValueRange, DictionaryAttr, RegionRange,
                             SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
ConstantOp::inferReturnTypes(MLIRContext *, Optional<Location> location,
                             ValueRange operands, DictionaryAttr attributes,
                             RegionRange,
                             SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
AbsOp::inferReturnTypes(MLIRContext *, Optional<Location> location,
                        ValueRange operands, DictionaryAttr attributes,
                        RegionRange regions,
                        SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
ComplexOp::inferReturnTypes(MLIRContext *, Optional<Location> location,
                            ValueRange operands, DictionaryAttr attributes,
                            RegionRange regions,
                            SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
ImagOp::inferReturnTypes(MLIRContext *, Optional<Location> location,
                         ValueRange operands, DictionaryAttr attributes,
                         RegionRange regions,
                         SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
IsFiniteOp::inferReturnTypes(MLIRContext *ctx, Optional<Location> location,
                             ValueRange operands, DictionaryAttr attributes,
                             RegionRange regions,
                             SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
RealOp::inferReturnTypes(MLIRContext *, Optional<Location> location,
                         ValueRange operands, DictionaryAttr attributes,
                         RegionRange regions,
                         SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
OutfeedOp::inferReturnTypes(MLIRContext *context, Optional<Location> location,
                            ValueRange, DictionaryAttr, RegionRange,
                            SmallVectorImpl<Type> &inferredReturnTypes) {
  auto dialect = context->getLoadedDialect<MhloDialect>();
...
LogicalResult
SendOp::inferReturnTypes(MLIRContext *context, Optional<Location> location,
                         ValueRange, DictionaryAttr, RegionRange,
                         SmallVectorImpl<Type> &inferredReturnTypes) {
  auto dialect = context->getLoadedDialect<MhloDialect>();
...
LogicalResult
PadOp::inferReturnTypes(MLIRContext *, Optional<Location> location,
                        ValueRange operands, DictionaryAttr attributes,
                        RegionRange regions,
                        SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
IfOp::inferReturnTypes(MLIRContext *context, Optional<Location> location,
                       ValueRange operands, DictionaryAttr attributes,
                       RegionRange regions,
                       SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
CaseOp::inferReturnTypes(MLIRContext *context, Optional<Location> location,
                         ValueRange operands, DictionaryAttr attributes,
                         RegionRange regions,
                         SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
TransposeOp::inferReturnTypes(MLIRContext *, Optional<Location> loc,
                              ValueRange operands, DictionaryAttr attributes,
                              RegionRange regions,
                              SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
TupleOp::inferReturnTypes(MLIRContext *context, Optional<Location> location,
                          ValueRange operands, DictionaryAttr attributes,
                          RegionRange regions,
                          SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
ScatterOp::inferReturnTypes(MLIRContext *, Optional<Location> location,
                            ValueRange operands, DictionaryAttr attributes,
                            RegionRange regions,
                            SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult
WhileOp::inferReturnTypes(MLIRContext *context, Optional<Location> location,
                          ValueRange operands, DictionaryAttr attributes,
                          RegionRange regions,
                          SmallVectorImpl<Type> &inferredReturnTypes) {
...
LogicalResult MhloDialect::verifyRegionArgAttribute(Operation *op,
  ...
  if (attr.getName() == "mhlo.parameter_replication") {
    ...
    // [true,...,true]
    if (arrayAttr.size() == 0 || arrayAttr.size() == 1)
      return success();
